...
export const VIRAL_ANALYSIS_API_URL =
  import.meta.env.VITE_VIRAL_ANALYSIS_API_URL ?? "http://localhost:5000";
...
export const viralAnalysisAxios = axios.create({
  baseURL: VIRAL_ANALYSIS_API_URL,
  headers: { "Content-Type": "application/json" },
});
